Feature: Get, Create & Update Items
  ...
  Scenario: Add Item
    Given I have the following data
      | site_id | tax_class_id | serial_no | type_id | name | description | date_added | date_updated | is_taxable | is_active | has_variations |
      | 1       | 1            | SN123     | 1       | name | description | 2001-1-1 1:1:1    | 2001-1-1 1:1:1      | true       | true      | true           |

Feature: Get, Create & Update Items
  ...
  Scenario: Add Item
    Given I have the following data
      | tax_class_id  | serial_no | name | description | date_added     | date_updated   | is_taxable | is_active | has_variations |
      | 1                  | SN123     | name | description | 2001-1-1 1:1:1 | 2001-1-1 1:1:1 | true       | true      | true           |
